...
function startup() {
    ...
    home2ndColorPicker.value = default2ndColor;
    ...
    awayColorPicker.value = defaultColor;
    ...
    away2ndColorPicker.value = default2ndColor;
